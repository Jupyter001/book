...
## 附着率
定义：汽车直线行驶条件下，充分发挥驱动作用要求的最低附着系数。
...
### 轮胎切向制动力
由制动力矩引起的、地面作用在车轮上的切向力。

取决于两个因素：
- 轮胎制动力矩
- 地面附着力

轮胎制动力较小时，地面切向制动力等于制动器制动力
制动力较大时，地面制动力等于=附着系数*载荷

### 汽车操作稳定性
将汽车作为控制系统，以汽车曲线行驶时的时域响应和频域响应表征汽车的的操纵稳定性。
- 时域响应：自变量是时间，纵轴是信号变化。
- 频域响应：自变量是频域，纵轴是该频率信号的幅度。


### 汽车的平顺性：
保持汽车在行驶过程中乘员所处的振动环境对乘员舒适性的影响在一定界限之内。